                        ...
                        <div class="col-md-6">
                            <div class="form">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="ad_name" placeholder="Admin Name" required="1"
                                        class="form-control">
                                    <label>Admin Email :</label>
                                    <input type="email" name="ad_email" placeholder="Admin Email" required="1"
                                        class="form-control">
                                    ...
                                    <input type="Password" name="ad_pass" placeholder="Admin Password" required="1"
                                        class="form-control">
